...
Usage:
  # Stage 1: VQ-VAE
  python chain_flow/train.py --stage vqvae --data chain_flow/data/train_data.pkl

  # Stage 2: Flow (requires trained VQ-VAE)
  python chain_flow/train.py --stage flow --data chain_flow/data/train_data.pkl \
    --vqvae_ckpt chain_flow/checkpoints/vqvae_best.pt

  # Direct flow (no VQ-VAE, simpler pipeline)
  python chain_flow/train.py --stage direct_flow --data chain_flow/data/train_data.pkl
"""
...
from chain_flow.dataset import ChainFlowDataset, SHAPE_DIM, WINDOW_SIZE
from chain_flow.chain_shape import DESCRIPTOR_DIM
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_dir", default="chain_flow/checkpoints")
