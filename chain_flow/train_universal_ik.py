...
Usage:
  # 합성 데이터 생성
  python chain_flow/synthetic_data.py --n_samples 200000 --n_configs 5000

  # 학습
  python chain_flow/train_universal_ik.py --data chain_flow/data/synthetic_ik_data.pkl --epochs 300
"""
...
from chain_flow.synthetic_data import DESC_DIM, SHAPE_DIM
